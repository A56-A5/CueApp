...
Cue is a lightweight, stylish utility designed to **instantly launch groups of programs or URLs** using simple custom-named cues (modes). Whether you're starting a "focus" mode, a "drawing" mode, or a "gaming" mode, Cue lets you configure and trigger all the required tools with a single click.


<img src="images/view.png" width="49%" /> <img src="images/add.png" width="49%" />
